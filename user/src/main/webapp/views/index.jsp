...
<%--</head>--%>
<%--<body id="page-top">--%>
<%--&lt;%&ndash;<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">&ndash;%&gt;--%>
<%--&lt;%&ndash;    <div class="container">&ndash;%&gt;--%>
<%--&lt;%&ndash;        <a class="navbar-brand" href="#page-top">&ndash;%&gt;--%>
<%--&lt;%&ndash;            <img src="<c:url value='/assets/img/navbar-logo.svg'/>" alt="Navbar Logo" />&ndash;%&gt;--%>
<%--&lt;%&ndash;        </a>&ndash;%&gt;--%>
<%--&lt;%&ndash;        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation">&ndash;%&gt;--%>
<%--&lt;%&ndash;            Menu&ndash;%&gt;--%>
<%--&lt;%&ndash;            <i class="fas fa-bars ms-1"></i>&ndash;%&gt;--%>
<%--&lt;%&ndash;        </button>&ndash;%&gt;--%>
<%--&lt;%&ndash;        <div class="collapse navbar-collapse" id="navbarResponsive">&ndash;%&gt;--%>
<%--&lt;%&ndash;            <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">&ndash;%&gt;--%>
<%--&lt;%&ndash;                <li class="nav-item"><a class="nav-link" href="#services">Services</a></li>&ndash;%&gt;--%>
<%--&lt;%&ndash;                <li class="nav-item"><a class="nav-link" href="#trainer">Trainer Profile</a></li>&ndash;%&gt;--%>
<%--&lt;%&ndash;                <li class="nav-item"><a class="nav-link" href="#about">About</a></li>&ndash;%&gt;--%>
<%--&lt;%&ndash;                <li class="nav-item"><a class="nav-link" href="#location">Location</a></li>&ndash;%&gt;--%>
<%--&lt;%&ndash;                <li class="nav-item"><a class="nav-link" href="#contact">Contact</a></li>&ndash;%&gt;--%>

<%--&lt;%&ndash;                <!-- Dropdown for Sign In and Sign Up -->&ndash;%&gt;--%>
...
<%--&lt;%&ndash;                        <li><a class="dropdown-item" href="<c:url value='/login'/>">Login</a></li>&ndash;%&gt;--%>
<%--&lt;%&ndash;                        <li><a class="dropdown-item" href="<c:url value='/signup'/>">Sign Up</a></li>&ndash;%&gt;--%>
<%--&lt;%&ndash;                    </ul>&ndash;%&gt;--%>
<%--&lt;%&ndash;                </li>&ndash;%&gt;--%>
<%--&lt;%&ndash;            </ul>&ndash;%&gt;--%>
<%--&lt;%&ndash;        </div>&ndash;%&gt;--%>
