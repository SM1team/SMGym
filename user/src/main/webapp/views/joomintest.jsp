...
<section class="page-section" id="services">
  ...
  <div class="gym-layout">
    <!-- 러닝머신 7개 -->
    <div class="equipment running" style="top: 8%; left: 3%;" data-equipment-id="1">
    ...
    <div class="equipment running" style="top: 8%; left: 14%;" data-equipment-id="2">
      <i class="fas fa-running"></i>
      <h4>런닝머신 2</h4>
      <div class="bubble">
        <p><strong>러닝머신이란?</strong></p>
    ...
    <div class="equipment running" style="top: 8%; left: 25%;" data-equipment-id="3" >
      <i class="fas fa-running"></i>
      <h4>런닝머신 3</h4>
      <div class="bubble">
        <p><strong>러닝머신이란?</strong></p>
    ...
    <div class="equipment running" style="top: 8%; left: 36%;" data-equipment-id="4">
      <i class="fas fa-running"></i>
      <h4>런닝머신 4</h4>
      <div class="bubble">
        <p><strong>러닝머신이란?</strong></p>
    ...
    <div class="equipment running" style="top: 8%; left: 47%;" data-equipment-id="5">
      <i class="fas fa-running"></i>
      <h4>런닝머신 5</h4>
      <div class="bubble">
        <p><strong>러닝머신이란?</strong></p>
    ...
    <div class="equipment running" style="top: 8%; left: 58%;" data-equipment-id="6">
      <i class="fas fa-running"></i>
      <h4>런닝머신 6</h4>
      <div class="bubble">
        <p><strong>러닝머신이란?</strong></p>
    ...
    <div class="equipment running" style="top: 8%; left: 69%;" data-equipment-id="7">
      <i class="fas fa-running"></i>
      <h4>런닝머신 7</h4>
      <div class="bubble">
        <p><strong>러닝머신이란?</strong></p>
    ...
    <!-- 밴치프레스 -->
    <div class="equipment weight" style="top: 25%; left: 13%;" data-equipment-id="8">
    ...
    <!-- 숄더프레스 -->
    <div class="equipment weight" style="top: 25%; left: 25%;" data-equipment-id="9">
      <i class="fas fa-dumbbell"></i>
      <h4>숄더 프레스</h4>
      <div class="bubble">
    ...
    <!-- 플라잉 머신 -->
    <div class="equipment weight" style="top: 25%; left: 37%;" data-equipment-id="10">
      <i class="fas fa-dumbbell"></i>
      <h4>플라잉 머신</h4>
      <div class="bubble">
    ...
    <!-- 사이클 머신 2개 추가 -->
    <div class="equipment cardio" style="top: 25%; left: 50%;" data-equipment-id="11">
    ...
    <div class="equipment cardio" style="top: 38%; left: 50%; " data-equipment-id="12">
      <i class="fas fa-bicycle"></i>
      <h4>스핀 바이크 2</h4>
      <div class="bubble">
        <p><strong>스핀 바이크란?</strong></p>
    ...
    <div class="equipment cardio" style="top: 51%; left: 50%; " data-equipment-id="11">
      <i class="fas fa-bicycle"></i>
      <h4>인도어사이클 1</h4>
      <div class="bubble">
