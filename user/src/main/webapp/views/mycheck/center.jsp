    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="chart-container">
                <h5 class="card-title mb-0 text-center">나의 월별 출석</h5>
        ...
        function fetchDataAndUpdateChart() {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (chart) {
                        // 기존 차트가 있으면 데이터와 애니메이션 업데이트
                        chart.data.labels = labels;
                        chart.data.datasets[0].data = counts;
                        chart.update({
                            duration: 1000, // 애니메이션 지속 시간 (밀리초)
                            easing: 'easeInOutQuad', // 부드러운 전환 효과
                        });
                    } else {
                        // 처음 로드 시 차트를 생성
                        ...
                        gradient.addColorStop(0, 'rgba(174, 0, 199, 0.8)');
                        gradient.addColorStop(1, 'rgba(135, 0, 154, 0.3)');
                                ...
                                datasets: [
                                    {
                                        ...
                                        borderColor: 'rgba(174, 0, 199, 1)',
                                        pointBackgroundColor: 'rgba(255, 255, 255, 1)',
                                        pointBorderColor: 'rgba(174, 0, 199, 1)',
                                        pointHoverBackgroundColor: '#fff',
                                        pointHoverBorderColor: 'rgba(174, 0, 199, 1)',
