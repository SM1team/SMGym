    ...
    <c:if test="${totalNoticeCount > 0}">
        ...
        <ul class="pagination">
            ...
            <li class="<c:if test='${page == 1}'>disabled</c:if>">
                <a href="<c:url value='/notice/list?page=1' />" aria-label="First">
            ...
            <!-- 이전 페이지로 이동 버튼 -->
            <li class="<c:if test='${page == 1}'>disabled</c:if>">
                <a href="<c:url value='/notice/list?page=${page - 1}' />" aria-label="Previous">
            ...
            <li class="<c:if test='${page == totalPages}'>disabled</c:if>">
                <a href="<c:url value='/notice/list?page=${page + 1}' />" aria-label="Next">
            ...
            <!-- 마지막 페이지로 이동 버튼 -->
            <li class="<c:if test='${page == totalPages}'>disabled</c:if>">
                <a href="<c:url value='/notice/list?page=${totalPages}' />" aria-label="Last">
