...
public class QRController {
    ...
    @Autowired
    private TrainerCheckService trainerCheckService;
    ...
    public String generateQRCode(HttpSession session, Model model) {
        ...
        TrainerDto loginUser = (TrainerDto) session.getAttribute("loginid");
        ...
        String trainerId = loginUser.getTrainerId();

        // QR 코드 생성
        String qrCodeBase64 = trainerCheckService.generateQRCode(trainerId);
        ...
        model.addAttribute("center", "qr/" + "center");
